<template>
  <div id="feedContainer">
    <div id="titleContainer">
      ...
      <a id="feedNumber"
        ><span id="feedNumberText">{{ feeds.length }}</span></a
      >
    </div>
              ...
              .onSnapshot((querySnapShot) => {
                ...
                querySnapShot.forEach((doc) => {
                  ...
                  if (feedData.content.length > 76) {
                    feedData.shortContent =
                      feedData.content.slice(0, 76) + "...";
                  } else {
                  ...
                  database
                    ...
                    .then((docSnapShot) => {
                      database
                        .firestore()
                        .collection("services")
                        .doc(docSnapShot.data().serviceId)
                        .get()
                        .then((docSnapShot) => {
                          if (docSnapShot.exists) {
                            ...
                            console.log(
                              "Services for this activity does not exist"
                            );
                          }
...
li {
  ...
  box-shadow: 0 2px 4px 0 rgba(117, 117, 117, 0.2),
    0 3px 10px 0 rgba(117, 117, 117, 0.19);
  background: #fff;
