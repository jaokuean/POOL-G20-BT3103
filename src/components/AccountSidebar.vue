    ...
    <div id="pools">
      ...
      <ul>
        <li v-for="pool in pools" :key="pool.index">
          ...
          <p style="text-align: center">{{ pool.name }}</p>
        </li>
      </ul>
    </div>
  </div>
...
<script>
//Current problem: spending text background does not cover all of 12%
//img component of pools div cannot be centered using align or padding-left
...
export default {
  ...
  data: function () {
    return {
      ...
      pools: [
        {
          imgURL: "https://www.scdn.co/i/_global/twitter_card-default.jpg",
          name: "pool1",
        },
        {
          imgURL:
            "https://images-na.ssl-images-amazon.com/images/I/41Y-MUPJU7L.png",
          name: "pool2",
        },
      ],
    };
      ...
      database
        ...
        .then(async (doc) => {
          ...
          if (doc.exists) {
            ...
            console.log("user phone: " + doc.data().phone);
            console.log("user pool: " + doc.data().pools);
